...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql_propiedad = "insert into propiedad values (null, '$sector','$telefono' , '$precio', '$tipo', '$baño', '$habitacion', '$amoblado', '$superficie', '$estacionamiento', '$servicio_aseo', '$gastos_comunes', '$descripcion', '$usuario', '0')";
