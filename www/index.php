        ...
        <header class="main-header">
            ...
            <div class="login">
                <form action="usuarios/usuario.php" method="POST" class="cont-login">
                    ...
                    <input class="boton-principal-add" style="border:none;" type="submit" name="submit" value="Iniciar sesión">
                </form>
            </div>
            <?php } ?>
            <!-- Boton menu movil -->
                ...
                <div class="contenedor-login">
                    <div class="login-section">
                        ...
                        <form action="usuarios/usuario.php" method="POST" class="cont-login">
                            ...
                            <input style="border:none;" class="boton-principal-add boton-login-movil" type="submit" name="submit" value="Iniciar sesión">
                        </form>
                    </div>
                </div>
            <?php } ?>
