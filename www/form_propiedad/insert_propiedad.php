...
<?php
    ...
    if(isset($_POST['enviarFormulario'])){
        ...
        // Guardamos y validamos las variables.
        $sector = $_POST['sector'];
        $precio = $_POST['precio'];
        $tipo = $_POST['tipo'];
        $baño = $_POST['baño'];
        ...
        $sql_propiedad = "insert into propiedad values (null,'$fecha' ,'$sector' ,'$telefono' , '$precio', '$tipo', '$baño', '$habitacion', '$amoblado', '$superficie', '$estacionamiento', '$servicio_aseo', '$gastos_comunes', '$descripcion', '$usuario', '0')";
