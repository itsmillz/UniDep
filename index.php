        ...
        <div class="segundo-container">
            ...
            <div class="contenedor-principal-buscador">
                <div class="contenedor-secundario-buscador">
                    ...
                    <input onkeyup="buscar_ahora($('#buscar').val());" type="search" name="buscar" id="buscar" value="" placeholder="Ingrese su universidad para mostrar arriendos cercanos">
                </div>
            </div>
        </div>
            ...
            <section class="contenedor-filtros">
                <form action="" method="POST" action="index.php">
                    ...
                    <section class="filtro-precio">
                        ...
                        <div class="filtro-precio-interior">
                            <div class="precio-desde">
                                <input type="number" name="gastoscomunesdesde" value="<?php echo $_POST["gastoscomunesdesde"]; ?>" placeholder="Desde">
                            </div>
                            <div class="precio-hasta">
                                <input type="number" name="gastoscomuneshasta" value="<?php echo $_POST["gastoscomuneshasta"]; ?>" placeholder="Hasta">
                            </div>
                        </div>
                    </section>
